...
class ModelArguments:
    ...
    model_type: Optional[str] = field(
        default=None,
        metadata={"help": "Model type: 130m, 370m, 790m, 1.4b, 2.8b "},
    )
...
model_config = { '130m' : MambaConfig(hidden_size=768, num_hidden_layers=24, vocab_size=51200), 
                 '370m' : MambaConfig(hidden_size=1024, num_hidden_layers=48, vocab_size=51200),
                 '790m' : MambaConfig(hidden_size=1536, num_hidden_layers=48, vocab_size=51200),
                 '1.4b' : MambaConfig(hidden_size=2048, num_hidden_layers=48, vocab_size=51200),
                 '2.8b' : MambaConfig(hidden_size=2560, num_hidden_layers=64, vocab_size=51200) }
...
def main(): 
    ...
    model_conf = model_config[model_args.model_type]
    model = MambaForCausalLM(config=model_conf)
    logger.info(model)
